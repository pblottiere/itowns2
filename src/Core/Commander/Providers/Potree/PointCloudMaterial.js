...
define(['THREE', './Shaders', './PointSizeType', './TreeType','./PointShape', './PointColorType', './ClipMode', './Gradients', './Classification'],
function(THREE, Shaders, PointSizeType, TreeType, PointShape, PointColorType, ClipMode, Gradients, Classification){
//define(['THREE', 'src/Renderer/ThreeExtented/ImageUtils', './Shaders', './PointSizeType', './TreeType','./PointShape', './PointColorType', './ClipMode', './Gradients', './Classification'],
