...
onmessage = function(event){
    console.log("GreyhoundBinaryDecoderWorker.onmessage begin");
	...
	for(var i = 0; i < pointAttributes.attributes.length; i++){
		...
		}else if(pointAttribute.name === 10){
