...
GreyhoundLoader = function(){
  console.log("GreyhoundLoader.cst");
};
...
var createSchema = function(attributes) {
  console.log("GreyhoundLoader.createSchema");
  var schema = [
 ...
 */
GreyhoundLoader.prototype.load = function load(url, callback) {
  console.log("GreyhoundLoader.load");
		...
		xhr.onreadystatechange = function() {
			if(xhr.readyState === 4 && (xhr.status === 200 || xhr.status === 0)){
				...
				*/
				...
				pgg.loader = new GreyhoundBinaryLoader(
				...
				{ // load root
					...
					console.log("points: ");
					console.log(greyhoundInfo.numPoints);
					pgg.root = root;
					pgg.root.load();
					nodes[name] = root;
				}
...
GreyhoundLoader.loadPointAttributes = function(mno){
  console.log("GreyhoundLoader.loadPointAttributes");
...
GreyhoundLoader.createChildAABB = function(aabb, childIndex){
  console.log("GreyhoundLoader.createChildAABB");
