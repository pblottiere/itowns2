...
PointCloudOctree.prototype.updateVisibility = function(camera, renderer){
	...
	while(priorityQueue.size() > 0){
	    console.log("PointCloudOctree.priorityQueue loop ", priorityQueue.size());
		...
		if(node instanceof PointCloudOctreeGeometryNode
			|| node instanceof PointCloudGreyhoundGeometryNode){
		    console.log("PointCloudOctree node is instance of PointCloudOctreeGeometryNode");
		...
		if(node instanceof PointCloudOctreeNode){
		    console.log("PointCloudOctree node is instance of PointCloudOctreeNode");
